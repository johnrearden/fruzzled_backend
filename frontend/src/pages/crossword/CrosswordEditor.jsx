...
export const CrosswordEditor = ({ data }) => {
    ...
    const currentClueModalTextRef = useRef();
    ...
    useEffect(() => {
        if (showClueTextModal) {
            currentClueModalTextRef.current.focus();
            currentClueModalTextRef.current.select();
        }
    }, [showClueTextModal])
    ...
    const handleKeyPress = event => {
        ...
        console.log(showClueTextModal)
        if (currentClue == null || showClueTextModal) return;
    ...
    console.log('showClueTextModal', showClueTextModal)
    return (
        <div className={styles.container}>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Clue text for : {currentWord.toUpperCase()}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <textarea
                        ref={currentClueModalTextRef}
                        rows="6"
