...
urlpatterns = [
    ...
    path('get_puzzle/<int:puzzle_id>/',
         views.GetPuzzle.as_view(),
         name='get_puzzle'),
    path('get_unseen_puzzle/',
         views.GetUnseenPuzzle.as_view(),
         name='get_unseen_puzzle'),
    path('create_new_puzzle/', views.CreateNewPuzzle.as_view(),
         name='create_new_puzzle'),
    path('delete_puzzle/<int:id>/',
         views.DeletePuzzle.as_view(),
         name='delete_puzzle'),
